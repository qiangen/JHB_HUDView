#
#  Be sure to run `pod spec lint JHB_HUDView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Minion" => "" }
  # Or just: s.author    = "Minion"
  # s.authors            = { "Minion" => "" }
  # s.social_media_url   = "http://twitter.com/Minion"
  ...
  s.source       = { :git => "https://github.com/BruceFight/JHB_HUDView.git", :tag => "0.0.1" }
